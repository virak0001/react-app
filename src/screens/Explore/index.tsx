const angkor =  require('../../assets/images/index/angkor.jpg');
const Explore = () => (
    <div className='overflow-y-hidden'>
      <div className="xl:mx-auto xl:container  xl:px-20 md:px-6 px-4 py-12">
        <div className="lg:flex items-center justify-center lg:space-x-12 2xl:space-x-6">
          <div className=''>
            <p className="lg:text-4xl text-3xl font-extrabold leading-9 text-gray-800">Popular Place</p>
            <p className="text-lg leading-7 text-gray-600 mt-4 xl:w-7/12 w-full">Here, We would like to show you about the popular place in Cambodia that is only one on the world</p>
            <div className="lg:hidden lg:w-3/5 xl:w-3/5 w-full lg:mt-0 mt-6">
              <img src={angkor} alt="ongoing meeting" className="w-full obejct-fit object-center object-fill h-full" />
            </div>
            <div className="mt-6 md:mt-10 grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-6 lg:mt-6 2xl:mt-12">
              <div className="flex items-center">
                ...
                <div className="flex items-start flex-col ml-6 pt-8">
                  ...
                  <p className="lg:w-40 2xl:w-52 text-base leading-6 mt-2 text-gray-600">In the morning we suggest on 6-7 AM is the good time for sunshine</p>
                </div>
              </div>
              <div className="flex items-center">
                <div className="w-16 h-16 relative">
                ...
                <div className="flex items-start flex-col ml-6 pt-8">
                  ...
                  <p className="lg:w-40 2xl:w-52 text-base leading-6 mt-2 text-gray-600">Angkor Wat is the largest religious monument on the planet</p>
                </div>
              </div>
              <div className="flex items-center">
                <div className="w-16 h-16 relative">
                ...
                <div className="flex items-start flex-col ml-6 pt-8">
                  ...
                  <p className="lg:w-40 2xl:w-52 text-base leading-6 mt-2 text-gray-600">Angkor Wat is breathtaking architectural of visitors each day</p>
                </div>
              </div>
              <div className="flex items-center">
                <div className="w-16 h-16 relative">
                ...
                <div className="flex items-start flex-col ml-6 pt-8">
                  ...
                  <p className="lg:w-40 2xl:w-52 text-base leading-6 mt-2 text-gray-600">More than 664,000 tourists have visit Angkor Wat during he Pchum Ben holiday</p>
                </div>
              </div>
            </div>
          </div>
