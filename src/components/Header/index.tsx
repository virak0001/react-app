        ...
        return (
            <React.Fragment>
                <div className="relative">
                    <div className="w-full bg-white mx-auto px-4 sm:px-6 border-2">
                        <div className="flex justify-between items-center py-6 md:justify-start md:space-x-10 text-black">
                            <div className="flex justify-start lg:w-0 lg:flex-1 text-2xl">
                                <FaMapMarkerAlt className="mt-1"/>
                                <strong className="ml-3 font-sans">Khmer Culture</strong>
                            </div>
                            <div className="-mr-2 -my-2 md:hidden">
                                <button type="button" className="rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500" aria-expanded="false">
                        ...
                        <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
                            <div className="pt-5 pb-6 px-5">
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="-mr-2">
                                        <button type="button" className="bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover: hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
